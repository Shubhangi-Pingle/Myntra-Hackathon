...
def save_data(df: pd.DataFrame, df_comments: pd.DataFrame) -> None:
    ...
    df.to_csv(r"C:\Users\uSER\Downloads\Future-Fashion-Trends-Forecasting-main\Future-Fashion-Trends-Forecasting-main\data\posts.csv", index=False)
    df_comments.to_csv(r"C:\Users\uSER\Downloads\Future-Fashion-Trends-Forecasting-main\Future-Fashion-Trends-Forecasting-main\data\posts_comments.csv", index=False, sep=';')
    
    
def main():
    path = r"C:\Users\uSER\Downloads\Future-Fashion-Trends-Forecasting-main\Future-Fashion-Trends-Forecasting-main\data\posts_1.json"
    path2 = r"C:\Users\uSER\Downloads\Future-Fashion-Trends-Forecasting-main\Future-Fashion-Trends-Forecasting-main\data\posts_2.json"
